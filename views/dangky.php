                    ...
                    <div class="card-body mx-auto">
                        ...
                        <form action="index.php?action=dangky&act=dangky_action" method="post" class="form" role="form">
                            ...
                            <div class="form-group input-group">
                                ...
                                <input class="form-control" name="Repeatpassword" placeholder="Repeatpassword" type="password">
                            </div>
                            <div class="form-group">
                                <button type="submit" name="dangky" class="btn btn-primary btn-block"> Create Account </button>
                            </div>
